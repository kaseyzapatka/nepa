# --------------------------
# CLEAN ENERGY DEFINITIONS: SETUP
# --------------------------
# Shared setup for clean energy definition scripts
...
output_dir <- here("output", "_project_overview")
figures_dir <- here("output", "_project_overview", "figures")
