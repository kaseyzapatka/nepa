...
- **Nuclear + Waste Management:** We started with approximately **4,000 Nuclear Waste projects** (those tagged with "Waste Management" AND ("Nuclear Technology" OR "Conventional Energy Production - Nuclear")). By excluding all projects sponsored by DOE's National Nuclear Security Administration (NNSA), Office of Environmental Management (EM), and Office of Legacy Management (LM), along with their associated field offices, this filtering reduced the dataset from approximately 4,000 nuclear-waste projects down to **1,588 projects**, focusing the analysis on nuclear energy research and development rather than waste cleanup or weapons programs. [You can see a list of the remaining nuclear-tagged projects here.](https://docs.google.com/spreadsheets/d/11J6hU15ngCQP-Quk8h2eSkwct7cmq8Zigl_XsDbpsi0/edit?gid=1263485295#gid=1263485295)
