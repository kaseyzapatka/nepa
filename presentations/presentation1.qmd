...
format:
  revealjs:
    ...
    slide-number: c/t
    logo: catf-logo.png
    footer: "NEPA Decarbonization Technologies Analysis — Phase 1 &nbsp;|&nbsp; <a href='../project_overview.html' target='_blank' style='color:#0047BB;text-decoration:underline;font-weight:600;'>See full analysis on website →</a> &nbsp;|&nbsp; <span style='color:#FF6600;font-weight:700;'>PRELIMINARY — NOT FOR EXTERNAL DISTRIBUTION</span>"
    transition: slide
...
See the **full report:** [on the project's website](../project_overview.html)
...
[Full Analysis Website](../project_overview.html) | [NEPATEC 2.0](https://huggingface.co/datasets/PNNL/NEPATEC2.0)
...
[Full Analysis Website](../project_overview.html) &nbsp;&nbsp;|&nbsp;&nbsp; [NEPATEC 2.0 Data](https://huggingface.co/datasets/PNNL/NEPATEC2.0)
