...
- **See Appendix for detailed coverage note:** Only DOE, BLM, and Forest Service have comprehensive CE, EA and EIS data so the second figure limits to those departments/agencies for a clearer picture.
...
::: {.callout-finding}
**Coverage note:** Only DOE, BLM, and Forest Service have comprehensive CE, EA and EIS data so the second figure limits to those departments/agencies for a clearer picture.
::: 
---
