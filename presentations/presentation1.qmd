...
n_clean <- tryCatch({
  read_parquet(here("phase1", "data", "analysis", "projects_combined.parquet")) |>
...
# Paths
overview <- here("phase1", "output", "_project_overview", "figures")
d1_figures <- here("phase1", "output", "deliverable1", "figures")
d1_maps    <- here("phase1", "output", "deliverable1", "maps")
