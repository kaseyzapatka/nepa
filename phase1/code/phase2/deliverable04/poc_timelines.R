...
bert <- read_parquet(here("phase1", "data", "analysis", "projects_timeline_bert.parquet"))
noi <- read_parquet(here("phase1", "data", "analysis", "noi_federal_register.parquet"))
...
ea_pages <- read_parquet(here("phase1", "data", "processed", "ea", "documents.parquet"))
eis_pages <- read_parquet(here("phase1", "data", "processed", "eis", "documents.parquet"))
