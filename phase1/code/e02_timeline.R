...
# LOAD DATA
# --------------------------
documents <- read_parquet(here("phase1", "data", "analysis", "documents_combined.parquet")) |> glimpse()
ea_pages <- read_parquet(here("phase1", "data", "processed", "ea", "pages.parquet")) |> glimpse()
projects_timeline <- read_parquet(here("phase1", "data", "analysis", "projects_timeline.parquet")) |> glimpse()

# llm results 
my_results <- read_parquet(here("phase1", "data", "analysis", "my_results.parquet")) |> glimpse()
my_results2 <- read_parquet(here("phase1", "data", "analysis", "my_results2.parquet")) |> glimpse()
my_results3 <- read_parquet(here("phase1", "data", "analysis", "my_results3.parquet")) |> glimpse()
my_results4 <- read_parquet(here("phase1", "data", "analysis", "my_results4.parquet")) |> glimpse()
my_results70b <- read_parquet(here("phase1", "data", "analysis", "my_results_70b.parquet")) |> glimpse()
my_resultsqwen <- read_parquet(here("phase1", "data", "analysis", "my_results_qwen.parquet")) |> glimpse()
my_results100 <- read_parquet(here("phase1", "data", "analysis", "results_100_qwen14b.parquet")) |> glimpse()

# test runs by varying model size
test10_qwen2_14b <- read_parquet(here("phase1", "data", "analysis", "test10_qwen14b.parquet")) |> glimpse()
test10_qwen2_7b <- read_parquet(here("phase1", "data", "analysis", "test10_qwen2:7b.parquet")) |> glimpse()
test10_llama3 <- read_parquet(here("phase1", "data", "analysis", "test10_llama3.2.parquet")) |> glimpse()
test10_qwen7 <- read_parquet(here("phase1", "data", "analysis", "test10_hybrid_qwen7.parquet")) |> glimpse()
test10_qwen7_fixed <- read_parquet(here("phase1", "data", "analysis", "test10_hybrid_fixed.parquet")) |> glimpse()

#
test20 <- read_parquet(here("phase1", "data", "analysis", "test20_hybrid3.parquet")) |> glimpse()
test20_instruct <- read_parquet(here("phase1", "data", "analysis", "test20_hybrid3_instruct.parquet")) |> glimpse()
test20_workers <- read_parquet(here("phase1", "data", "analysis", "test20_workers.parquet")) |> glimpse()
...
# ------------------------------
ce_pages <-
  read_parquet(here("phase1", "data", "processed", "ce", "pages.parquet")) |>
...
timeline <- read_parquet(here("phase1", "data", "analysis", "projects_timeline.parquet"))
