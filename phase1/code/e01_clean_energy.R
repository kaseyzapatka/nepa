...
write_csv(military_project_ids_to_filter, here("phase1", "notes", "military_project_ids_to_filter.csv"))
...
timeline <- read_parquet(here("phase1", "data", "analysis", "projects_timeline.parquet")) |> glimpse()
