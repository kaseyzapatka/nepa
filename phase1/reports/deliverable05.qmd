...
d5_tables <- here("phase1", "output", "deliverable5", "tables")
```
...
```{r}
#| label: fig-coverage
#| fig-cap: "Project counts at each inclusion filter step, by NEPA process type. Percentages are relative to the total decarbonization technology EA/EIS projects at the first step."
#| out-width: "90%"
...
```{r}
#| label: fig-pre-post
#| fig-cap: "Mean regulatory pages for decarbonization technology EA and EIS projects, Pre- vs Post-FRA. Regulatory pages = body word count ÷ 500, per 40 C.F.R. § 1508.1(bb). Bar height = mean; diamond = median. Projects are classified by decision date relative to June 3, 2023."
#| out-width: "90%"
...
#| fig-cap: "FRA page limit compliance among Post-FRA decarbonization technology projects. Teal = compliant; amber = exceeds standard limit (EIS only, 151--300 pages); magenta = exceeds limit."
#| out-width: "90%"
