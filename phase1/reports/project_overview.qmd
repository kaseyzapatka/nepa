...
@fig-energy-type shows the overall distribution of projects in the NEPATEC 2.0 database by energy type. Decarbonization technology projects comprise roughly 37% of all projects in the database, while fossil fuel projects represent 18%, and other (non-energy) projects make up 45% of the total. This breakdown helps contextualize the decarbonization technology subset analyzed in subsequent deliverables within the broader universe of federal environmental reviews.
